package com.voally.vertical.core;

/**
 * 项目常量
 */
public final class ProjectConstant {
    public static final String BASE_PACKAGE = "com.voally.vertical";//项目基础包名称，根据自己公司的项目修改

    //public static final String DTO_PACKAGE = BASE_PACKAGE + ".api.entity";//DTO所在包
